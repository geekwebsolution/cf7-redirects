<?php
if (!class_exists('CF7RGK_Update_Checker')) {

    class CF7RGK_Update_Checker {
        ...
        public function __construct() {
            $utility = cf7rgk_updater_utility();
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'cf7rgk_plugin_updates';
